...
![Walmart Sales Dashboard](images/walmart_dashboard_cover.png)
...
*(Update the sales values based on your dashboard results)*
...
https://github.com/Menorah-Tee/Walmart-Sales-Forecasting/blob/main/Walmart.csv
